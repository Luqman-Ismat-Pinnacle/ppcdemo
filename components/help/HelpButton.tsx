...
const ROUTE_TO_HELP_ID: Record<string, string> = {
  ...
  '/login': 'login',
  '/shared/tasks': 'tasks',
  '/shared/mos-page': 'overview',
  '/insights/overview': 'overview',
  '/shared/documents': 'documents',
  '/shared/data-management': 'data-management',
  '/shared/wbs-gantt-v2': 'wbs-gantt',
  '/shared/resourcing': 'resourcing',
  '/shared/project-plans': 'project-plans',
  '/shared/forecast': 'forecast',
  '/shared/sprint': 'sprint',
  '/shared/documentation': 'documents',
  '/shared/qc-log': 'qc-log',
  '/feedback': 'feedback',
};
