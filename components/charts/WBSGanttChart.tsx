      ...
      formatter: (params: any) => {
        ...
        return `
          <div style="padding:8px 12px;">
            <div style="font-weight:600;color:#6366F1;margin-bottom:8px;border-bottom:1px solid rgba(99,102,241,0.3);padding-bottom:6px;display:flex;align-items:center;gap:8px;">
