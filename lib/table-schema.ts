...
export const TABLE_DEFS: TableDef[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'phase_id', label: 'Phase ID', type: 'text', editable: true },
      { key: 'unit_id', label: 'Unit ID', type: 'text', editable: true },
      { key: 'qc_status', label: 'QC Status', type: 'text', editable: true },
      { key: 'severity', label: 'Severity', type: 'text', editable: true },
      { key: 'item_count', label: 'Count', type: 'number', editable: true },
      { key: 'correct_count', label: 'Correct', type: 'number', editable: true },
      { key: 'minor_issues', label: 'Minor Issues', type: 'number', editable: true },
      { key: 'major_issues', label: 'Major Issues', type: 'number', editable: true },
      { key: 'checklist_score', label: 'Checklist Score', type: 'number', editable: true },
      { key: 'defects_found', label: 'Defects Found', type: 'number', editable: true },
      { key: 'defects_open', label: 'Defects Open', type: 'number', editable: true },
      { key: 'inspector', label: 'Inspector', type: 'text', editable: true },
      { key: 'inspected_at', label: 'Inspected At', type: 'date', editable: true },
      { key: 'resolved_at', label: 'Resolved At', type: 'date', editable: true },
