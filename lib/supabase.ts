...
export const TABLES = {
  ...
  PROJECT_DOCUMENT_RECORDS: 'project_document_records',
  PROJECT_DOCUMENT_VERSIONS: 'project_document_versions',
...
export const DATA_KEY_TO_TABLE: Record<string, TableName> = {
  ...
  projectDocumentRecords: TABLES.PROJECT_DOCUMENT_RECORDS,
  projectDocumentVersions: TABLES.PROJECT_DOCUMENT_VERSIONS,
