...
export function downloadFullTemplate(): void {
  ...
  const entities: ExportableEntity[] = [
    ...
    'hours', 'chargecodes', 'projectHealth'
  ];
...
/**
 * Get column headers for an entity type (updated for new schema with remaining hours/cost)
 */
function getEntityHeaders(entityType: ExportableEntity): string[] {
  const headers: Record<ExportableEntity, string[]> = {
    employees: ['employeeId', 'name', 'jobTitle', 'managementLevel', 'manager', 'email', 'employeeType', 'hourlyRate', 'utilizationPercent', 'isActive', 'createdAt', 'updatedAt'],
    portfolios: ['portfolioId', 'name', 'employeeId', 'manager', 'methodology', 'baselineStartDate', 'baselineEndDate', 'actualStartDate', 'actualEndDate', 'percentComplete', 'baselineHours', 'actualHours', 'remainingHours', 'baselineCost', 'actualCost', 'remainingCost', 'isActive', 'createdAt', 'updatedAt'],
    customers: ['customerId', 'name', 'portfolioId', 'employeeId', 'baselineStartDate', 'baselineEndDate', 'actualStartDate', 'actualEndDate', 'percentComplete', 'baselineHours', 'actualHours', 'remainingHours', 'baselineCost', 'actualCost', 'remainingCost', 'comments', 'isActive', 'createdAt', 'updatedAt'],
    sites: ['siteId', 'name', 'customerId', 'employeeId', 'location', 'baselineStartDate', 'baselineEndDate', 'actualStartDate', 'actualEndDate', 'percentComplete', 'baselineHours', 'actualHours', 'remainingHours', 'baselineCost', 'actualCost', 'remainingCost', 'comments', 'isActive', 'createdAt', 'updatedAt'],
    projects: ['projectId', 'name', 'customerId', 'siteId', 'employeeId', 'billableType', 'methodology', 'manager', 'status', 'baselineStartDate', 'baselineEndDate', 'actualStartDate', 'actualEndDate', 'percentComplete', 'baselineHours', 'actualHours', 'remainingHours', 'baselineCost', 'actualCost', 'remainingCost', 'cpi', 'spi', 'comments', 'isActive', 'createdAt', 'updatedAt'],
    phases: ['phaseId', 'name', 'projectId', 'employeeId', 'sequence', 'startDate', 'endDate', 'baselineStartDate', 'baselineEndDate', 'actualStartDate', 'actualEndDate', 'percentComplete', 'baselineHours', 'actualHours', 'remainingHours', 'baselineCost', 'actualCost', 'remainingCost', 'comments', 'isActive', 'createdAt', 'updatedAt'],
    tasks: ['taskId', 'taskName', 'taskDescription', 'projectId', 'phaseId', 'employeeId', 'status', 'priority', 'baselineStartDate', 'baselineEndDate', 'actualStartDate', 'actualEndDate', 'percentComplete', 'baselineHours', 'actualHours', 'remainingHours', 'baselineCost', 'actualCost', 'remainingCost', 'isCritical', 'predecessorId', 'comments', 'createdAt', 'updatedAt'],
    subTasks: ['taskId', 'parentTaskId', 'taskName', 'taskDescription', 'employeeId', 'status', 'priority', 'baselineStartDate', 'baselineEndDate', 'actualStartDate', 'actualEndDate', 'percentComplete', 'baselineHours', 'actualHours', 'remainingHours', 'baselineCost', 'actualCost', 'remainingCost', 'comments', 'createdAt', 'updatedAt'],
    hours: ['entryId', 'employeeId', 'taskId', 'projectId', 'phaseId', 'chargeCode', 'date', 'hours', 'description', 'isBillable', 'isApproved', 'createdAt', 'updatedAt'],
    qctasks: ['qcTaskId', 'parentTaskId', 'employeeId', 'qcType', 'qcStatus', 'qcHours', 'qcScore', 'qcCount', 'qcUOM', 'qcCriticalErrors', 'qcNonCriticalErrors', 'qcComments', 'qcStartDate', 'qcEndDate', 'createdAt', 'updatedAt'],
    milestones: ['milestoneId', 'milestoneName', 'projectId', 'phaseId', 'status', 'percentComplete', 'plannedDate', 'forecastedDate', 'actualDate', 'varianceDays', 'createdAt', 'updatedAt'],
    milestonesTable: ['milestoneId', 'milestoneName', 'projectId', 'phaseId', 'status', 'percentComplete', 'plannedDate', 'forecastedDate', 'actualDate', 'varianceDays', 'createdAt', 'updatedAt'],
    deliverables: ['deliverableId', 'name', 'projectId', 'phaseId', 'employeeId', 'type', 'status', 'dueDate', 'completedDate', 'percentComplete', 'comments', 'createdAt', 'updatedAt'],
    chargecodes: ['codeId', 'code', 'name', 'category', 'isActive', 'createdAt', 'updatedAt'],
    projectHealth: ['projectId', 'projectName', 'checkCategory', 'checkName', 'status', 'failureReason', 'comments', 'approvalType', 'approverName', 'approvalDate', 'isApproved', 'approvalComments', 'createdAt', 'updatedAt'],
  };
...
function getExampleRow(entityType: ExportableEntity): any {
  ...
  const examples: Record<ExportableEntity, any> = {
    ...
    qctasks: {
      ...
      qcUOM: 'documents',
      qcCriticalErrors: 0,
      qcNonCriticalErrors: 1,
      qcComments: 'Minor formatting issues',
      qcStartDate: '2025-01-06',
      qcEndDate: '2025-01-06',
      createdAt: now,
      updatedAt: now
    },
    milestones: {
    ...
    projectHealth: {
      ...
      checkCategory: 'Scope',
      checkName: 'Scope clearly defined',
      status: 'Pass',
      failureReason: '',
      comments: '',
      approvalType: 'Project Controls QC Complete',
