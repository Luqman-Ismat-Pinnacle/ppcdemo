...
export default function DocumentationPage() {
  ...
  const handleCreateRecord = useCallback(async (docType: DocType) => {
    ...
    try {
      await callDocs({
        ...
        owner: actorName,
        projectId: hierarchyFilter?.projectId || null,
        portfolioId: hierarchyFilter?.portfolioId || null,
        customerId: hierarchyFilter?.customerId || null,
        siteId: hierarchyFilter?.siteId || null,
        status: 'Not Started',
  ...
  }, [actorEmail, actorName, hierarchyFilter?.customerId, hierarchyFilter?.portfolioId, hierarchyFilter?.projectId, hierarchyFilter?.siteId, refreshData]);
  ...
  const uploadForRecord = useCallback(async (record: DocRecord, file: File) => {
    ...
    const scopedProject = record.projectId || hierarchyFilter?.projectId || 'global';
  ...
  }, [actorEmail, actorName, auditActor, hierarchyFilter?.projectId, refreshData]);
