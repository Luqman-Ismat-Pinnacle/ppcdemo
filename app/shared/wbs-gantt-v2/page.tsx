...
export default function WBSGanttV2Page() {
  ...
  useEffect(() => {
    ...
    setUiColors({
      ...
      // Keep the table and timeline panes opaque to prevent visual bleed/ghost
      // rows during horizontal/vertical scrolling.
      bgPrimary: pick('--bg-primary', '#0f141b'),
      bgSecondary: pick('--bg-secondary', '#0b1017'),
      bgTertiary: pick('--bg-tertiary', '#111824'),
