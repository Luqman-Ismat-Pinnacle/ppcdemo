  ...
  const sections: SectionConfig[] = useMemo(() => [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'department', header: 'Department', type: 'text', editable: true, tooltip: 'e.g. 1111 Services – used for COO role scoping' },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'deadline', header: 'Deadline', type: 'date', editable: true },
        { key: 'calendarId', header: 'Calendar', type: 'text', editable: true },
        { key: 'calendarName', header: 'Calendar Name', type: 'text', editable: true, tooltip: 'MPP calendar name' },
        { key: 'fixedCost', header: 'Fixed Cost', type: 'number', editable: true },
        { key: 'isEstimated', header: 'Estimated', type: 'boolean', editable: true },
        { key: 'isExternal', header: 'External', type: 'boolean', editable: true, tooltip: 'External task/subproject link' },
