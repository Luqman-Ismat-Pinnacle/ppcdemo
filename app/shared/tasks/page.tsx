  ...
  if (!hasData && !isLoading) {
    return (
      <div style={{ padding: '4rem', textAlign: 'center', background: C.bgCard, borderRadius: 24, margin: '2rem' }}>
        ...
        <button onClick={() => router.push('/shared/project-plans')} style={{ background: C.teal, color: '#000', padding: '0.75rem 1.5rem', borderRadius: 8, fontWeight: 700, border: 'none', cursor: 'pointer' }}>Go to Project Plans</button>
      </div>
    );
  }
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '1.5rem', marginTop: '0.75rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              <MetricProvenanceChip provenance={stats.efficiencyProvenance} value={`${stats.efficiency}%`} onExplain={onExplain} />
            </div>
