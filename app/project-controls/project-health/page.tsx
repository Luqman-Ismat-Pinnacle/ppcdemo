                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                      <thead>
                        <tr style={{ background: 'var(--bg-tertiary)' }}>
                          <th style={{ width: '40px', padding: '10px', textAlign: 'center', fontSize: '0.7rem', color: 'var(--text-muted)' }}>Pass</th>
                          <th style={{ padding: '10px', textAlign: 'left', fontSize: '0.7rem', color: 'var(--text-muted)' }}>Check Item</th>
                          <th style={{ width: '150px', padding: '10px', textAlign: 'left', fontSize: '0.7rem', color: 'var(--text-muted)' }}>Failure Reason</th>
                          <th style={{ width: '200px', padding: '10px', textAlign: 'left', fontSize: '0.7rem', color: 'var(--text-muted)' }}>Comments</th>
                        </tr>
                      </thead>
                      <tbody>
